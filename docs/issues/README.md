...
| [DS-002](DS-002.md) | P0 | Open | Replace approximate CVSS scoring |
...
| [DS-018](DS-018.md) | P1 | Open | Prevent sparse-index path panics on invalid crate names |
...
| [DS-033](DS-033.md) | P1 | Open | Reject malformed crates.io sparse-index lines |
...
| [DS-039](DS-039.md) | P1 | Open | Implement NuGet prerelease precedence correctly |
| [DS-040](DS-040.md) | P1 | Open | Reject malformed or unsupported lockfile schemas instead of returning empty |
| [DS-041](DS-041.md) | P1 | Open | Error when an explicitly requested config file is missing |
| [DS-042](DS-042.md) | P1 | Open | Make JSON output reproducible when requested |
